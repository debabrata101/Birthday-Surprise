...
function Mailbox({ onOpen }) {
  ...
  return (
    <div className="mx-auto block w-[min(420px,92vw)] text-center">
      ...
      >
        {/* box base */}
        <div className="w-[min(380px,88vw)] mx-auto bg-[#fffdf8] border border-[#f1d9df] rounded-xl shadow-[0_20px_60px_rgba(159,65,98,.12)] p-5 sm:p-6 pt-12">
        ...
        {/* lid */}
        <motion.div
          className="absolute left-1/2 -top-6 -translate-x-1/2 w-[min(420px,92vw)] h-20 origin-bottom rounded-t-xl bg-[#f3dfe7] border border-[#e8c5d3] shadow-md"
          initial={{ rotateX: 0 }}
        ...
        <motion.div
          className="absolute left-1/2 -top-2 -translate-x-1/2 w-[min(320px,72vw)]"
